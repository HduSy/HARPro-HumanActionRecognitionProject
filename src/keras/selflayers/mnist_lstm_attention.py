...
from src.keras.selflayers.keras_attention_layer import Attention_layer
...
#attention_mul = model.add(AttentionWithContext())
attention_mul = Attention_layer()(activations)
out_attention_mul = Flatten()(attention_mul)
output = Dense(10, activation='sigmoid')(out_attention_mul)
model = Model(inputs=inputs, outputs=output)
